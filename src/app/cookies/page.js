...
export const metadata = {
  title: "How Omnicnutrition Uses Cookies on This Site | Cookie Policy",
  description:
    "Learn how Omnicnutrition uses cookies to enhance your Browse experience, analyze site traffic, and personalize content on this website. Understand your choices regarding cookie usage.",
  openGraph: {
    title: "How Omnicnutrition Uses Cookies on This Site | Cookie Policy",
    description:
      "Learn how Omnicnutrition uses cookies to enhance your Browse experience, analyze site traffic, and personalize content on this website. Understand your choices regarding cookie usage.",
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600">
                  omnicnutrition.com (hereinafter referred to as "the Site,"
