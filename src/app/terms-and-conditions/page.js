...
export const metadata = {
  title: "Omnicnutrition – Terms & Conditions You Should Know",
  description:
    "Review Omnicnutrition’s Terms & Conditions to understand the rules, user responsibilities, and legal guidelines for using our website and services.",
  openGraph: {
    title: "Omnicnutrition – Terms & Conditions You Should Know",
    description:
      "Review Omnicnutrition’s Terms & Conditions to understand the rules, user responsibilities, and legal guidelines for using our website and services.",
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600">
                  By accessing and using omnicnutrition.com (hereinafter
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      All content on omnicnutrition.com, including but not
                      limited to text, images, graphics, logos, and software, is
                      the property of omnicnutrition.com or its licensors and is
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      The content on omnicnutrition.com is provided for
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      To the fullest extent permitted by law, omnicnutrition.com
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      You agree to indemnify and hold omnicnutrition.com
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="mt-2 text-gray-600">
                  Email:{" "}
                  <a
                    href="mailto:support@omnicnutrition.com"
                    className="text-green-600 hover:text-green-700 hover:underline"
                  >
                    support@omnicnutrition.com
                  </a>
                  <br />
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600">
                  ...
                  between you and omnicnutrition.com regarding your use of our
